...
<body style="padding-top: 60px;">
	...
	<div class="container" style="margin-top: 20px;">
		<div class="row">
			...
			<div class="col-sm-10">
				<div 　class="pull-left">
					<h3 style="padding: 0; margin: 0; margin-bottom: 10px;">小分類一覧</h3>
					<ol class="breadcrumb">
						<li><a href="/index">ホーム</a></li>
						<li class="active">小分類一覧</li>
					</ol>
					<table class="table table-bordered table-condensed"
						...
						<tbody>
							...
							<c:forEach var="cpn" items="${list}">
								<tr>
									<td scope="row"><a
										href="/ranksyou/update/${cpn.busyo_dai_code}/${cpn.busyo_cyu_code}/${cpn.busyo_syou_code}/${cpn.busyo_start}">${cpn.busyo_dai_code}${cpn.busyo_dai_code}${cpn.busyo_syou_code}</a></td>
				...
				<div class="pull-right">
					<button class="btn btn-danger"
						onclick="location.href='/ranksyou/insert'">登録</button>
				</div>
				<br />
...
body,div {
	...
	<!-- Paging -->
		function page(idx) {
			...
			var url = "${pageContext.request.contextPath}/ranksyou?pagenum="
		...
		$(document).on('click', '#btnSearch', function(e){
			e.preventDefault();
			var url = "${pageContext.request.contextPath}/ranksyou?pagenum=1&contentnum=10";
