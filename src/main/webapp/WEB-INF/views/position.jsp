...
<body style="padding-top: 60px;">
	...
	<div class="container" style="margin-top: 20px;">
		<div class="row">
			...
			<div class="col-sm-10">
				<div 　class="pull-left">
					<h3 style="padding: 0; margin: 0; margin-bottom: 10px;">職責一覧</h3>
					<ol class="breadcrumb">
						<li><a href="/index">ホーム</a>
						<li class="active">職責一覧</li>
					</ol>
								...
								<div>
									<div class="form-group">
										<select name="searchtype" id="searchtype"
											...
											<option class="active" value="position_code">コード</option>
											<option value="position_name">名称</option>
											<option value="position_name_smail">略称</option>
										</select>
									</div>
									<div class="form-group">
