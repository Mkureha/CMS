			...
			<div class="col-sm-10">
				<div class="pull-left">
					...
					<ol class="breadcrumb">
						...
						<li><a href="/rankcyu?pagenum=1&contentnum=10&searchtype=busyo_dai_code&keyword=">中分類一覧</a></li>
						<li class="active">情報修正</li>
					</ol>
					<div>
						<h5 class="pull-left"
							style="padding: 0; margin: 0; margin-bottom: 10px; 　color: red; font-weight: bold;">基本情報</h5>
						<form action="/rankcyu/updateProc" method="post"
							autocomplete="off">
							...
							<div class="text-right" style="position: relative;">
								<input type="button" value="削除" class="btn btn-danger"
									OnClick="location.href='/rankcyu/delete/${detail.busyo_dai_code}/${detail.busyo_cyu_code}/${detail.busyo_start}'">
